...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save the real signed JWT — never fall back to a mock string
      ...
      // patient_id is the user's own ID (the sub of the JWT)
      const patientId = data.user?.id || data.patient?.id || data.patient_id;
      if (patientId) {
