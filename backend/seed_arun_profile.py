...
def seed_arun_profile():
    ...
    # 2. Patient Profile (Asthma & Respiratory Specialty Focus)
    ...
    db.add(profile)
    db.commit()
    print("[OK] Created PatientProfile for Arun Kumar.")

    # 3. Patient Updates (Chronological history entries)
    updates_data = [
    ...
    # 5. Medical Files (Medical Reports, Lab Reports, Prescriptions)
    files_data = [
        (
    ...
    print("\n=======================================================")
    print(f"SUCCESS: New user profile successfully created!")
    print(f"Email: {email}")
    print(f"Password: {plaintext_pw}")
    print(f"User ID: {user_id}")
    print("Condition: Moderate Persistent Asthma & Allergic Rhinitis")
    print("Data Included: Patient Profile, 3 Medical Files, 3 Medications, 5 Timeline Events, Symptoms, AI Analysis, Care Plan, & Follow Up.")
    print("=======================================================\n")
