...
class Settings(BaseSettings):
    ...
    # Loaded from JWT_SECRET_KEY/SECRET_KEY at runtime by core.security. Never provide a fallback secret.
    SECRET_KEY: str = ""
    ALGORITHM: str = "HS256"
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60
    REFRESH_TOKEN_EXPIRE_DAYS: int = 7
    # Per-installation password hashing salt — override in production!
    # Must be supplied at runtime; core.security rejects missing/placeholder values.
    PASSWORD_SALT: str = ""
